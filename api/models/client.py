...
class Client(models.Model):
      ...
      ethnicity = models.IntegerField(null=True, default=99) # Keys for races
      gender = models.IntegerField(null=True, default=99) # Using boolean as a binary 1=F 0=M
      veteran = models.IntegerField(null=True, default=99)
      year_entered = models.IntegerField(null=True)
      year_exited = models.IntegerField(null=True)
      war_participated = ArrayField(models.IntegerField(), default=[], null=True) # Keys for wars
      ...
      date_updated = models.DateTimeField(null=True, default=timezone.now)
      associate_id = models.CharField(max_length=15, null=True)
